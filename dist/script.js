    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          statusMessage.textContent = _this.massage.loading;
...
function (_Slider) {
  ...
  function MainSlider(btnNext, btnPrev) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btnNext, btnPrev));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        if (n === 3) {
          setTimeout(function () {
            _this.$blockTime.classList.add('animated');

            _this.$blockTime.style.opacity = '1';

            _this.$blockTime.classList.add('slideInUp');
          }, 3000);
    ...
    key: "btnTrigger",
    value: function btnTrigger(btn, n) {
      var _this2 = this;
